      ...
      <div className="container">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
            Impulsa tus redes sociales con{' '}
            <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
              SocialBoost
            </span>
          </h1>
          <p className="text-lg text-muted-foreground mb-8">
            Aumenta tu presencia en línea con nuestros servicios de likes, seguidores,
            visualizaciones y más para todas las principales plataformas sociales.
          </p>
          ...
          <div className="mt-12 flex gap-6 justify-center items-center flex-wrap">
            ...
            <div className="flex items-center">
              <FaFacebookF className="text-blue-600 text-3xl mr-2" />
              <span className="font-medium">Facebook</span>
            </div>
            <div className="flex items-center">
              <FaTiktok className="text-black text-3xl mr-2" />
